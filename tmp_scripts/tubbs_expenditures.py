...
def fmt(row):
    ...
    count = int(row[1])
    amount = float(row[2])
    return f"{name:<70s} | ${amount:>14,.2f} | {count} transactions"

print("=" * 80)
print("TUBBS FOR LIEUTENANT GOVERNOR 2026; FRIENDS OF — EXPENDITURES")
print("Filer ID: 1479071")
print("=" * 80)

# Expenditures from expn_cd_deduped
cur.execute("""
SELECT
...
print()
print("=" * 80)
print("TUBBS FOR LIEUTENANT GOVERNOR 2026; MICHAEL — EXPENDITURES")
